...
class CEBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, keep_ratio_search=1.0,init_values=0.,):
        super().__init__()
    ...
    def forward(self, x, global_index_template, global_index_search, mask=None, ce_template_mask=None, keep_ratio_search=None):
        ...
        if self.gamma_1 is None:
            ...
            x = x + self.drop_path(x_attn * self.gamma_1)
        ...
        if self.gamma_1 is None:
            ...
            x = x + self.drop_path(self.mlp(self.norm2(x)) * self.gamma_2)
