...
"""ostrack"""
trackers.extend(trackerlist(name='ostrack', parameter_name='vit_tiny_256_mae_distill_d2_ce_32x4_ep300', dataset_name=dataset_name,
                            run_ids=None, display_name='OSTrack256_mae_d2_distill'))
